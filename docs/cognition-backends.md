...
- `DeterministicCognitionBackend`:
  ...
  - Supports the same API surface (`chat`, `stream_chat`, routing, health, model endpoints, onboarding profile recommendation, package catalog/install/license preflight`).
