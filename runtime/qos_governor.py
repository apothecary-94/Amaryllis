...
class QoSGovernor:
    ...
    def reconcile(self, *, snapshot: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        with self._lock:
            ...
            if not self._auto_enabled:
                ...
                target, reason = self._target_mode(current_mode=current, metrics=metrics)
    ...
    def _target_mode(self, *, current_mode: str, metrics: dict[str, float]) -> tuple[str, str]:
